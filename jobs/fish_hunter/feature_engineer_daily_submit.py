...
role (the only principal the oceanhunter source bucket trusts); the daily
grouped features are written to S3 under OUTPUT_ROOT.
"""
...
processor = PySparkProcessor(
    base_job_name="fm01-feature-daily",
