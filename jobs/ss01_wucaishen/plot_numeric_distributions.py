...
Uses DataProfiler and DataVisualizer from bituslabs_ds.eda. Numeric preparation
(including Parquet fixed_len_byte_array conversion), skewness, kurtosis, and
log y-scale for highly skewed features are handled by the EDA module.
