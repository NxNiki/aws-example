...
def scale_features(
    data: pd.DataFrame, output_dir: Union[str, Path], output_file_name: str, load_cache: bool = False
) -> pd.DataFrame:
    """
...
def run_cluster_analysis(data: pd.DataFrame, n_clusters: int, output_dir: Union[str, Path] = ".") -> np.ndarray:
    """
...
def plot_radar_chart(data: pd.DataFrame, data_cluster: np.ndarray, output_dir: Union[str, Path] = ".") -> None:
    """
