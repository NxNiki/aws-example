...
user_stats AS (
    ...
    FROM user_bets AS t
    GROUP BY t.activity_week, t.ab_group, t.mathtable, t.bet_level, t.user_id
)
...
ORDER BY us.activity_week DESC, us.ab_group DESC, us.mathtable DESC, us.user_id DESC;
