...
SELECT
    ...
    CASE
        WHEN DATEDIFF('day', fb.first_bet_date, t1.activity_month) <= 3 THEN 'new'
        WHEN DATEDIFF('day', fb.first_bet_date, t1.activity_month) <= 7 THEN 'beginner'
        ELSE 'old'
    END AS user_group,
...
LEFT JOIN user_session_stats_agg t4
    ...
    AND t1.activity_month = t4.activity_month
