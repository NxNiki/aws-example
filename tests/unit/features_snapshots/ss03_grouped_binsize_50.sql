WITH user_bets AS (
    ...
    WHERE
        ...
        AND ((t.partition_ab[0] IS NULL OR t.partition_ab[0] NOT IN ('jojpin-9mokha-rexQug', '4f1a46ca-7baa-4452-9a40-ef21d9b33b57', '4a04df21-c749-4808-8e55-3a0b74c084d2')))
),
...
binned AS (
    SELECT
        t.*,
        ROUND((t.session_bet_index - 1) / 50) AS agg_group
    FROM raw_stats AS t
),
