...
# Run: bash infra/docker_build_ai_agent.sh
...
docker build --platform linux/amd64 -t $IMAGE_NAME -f infra/Dockerfile.ai_agent ./
...
echo "  python infra/deploy_ai_agent_ecs.py --build-first"
echo "  # Or: bash infra/docker_build_ai_agent.sh && python infra/deploy_ai_agent_ecs.py"
